...
public class ReadingConvoConvo extends ReadingCommand {
    ...
    public void dealWithStop(Player player) {
        ...
        if (localName == null) {
            player.sendMessage(MessageUtils.BAD + "There is no local category with that uid.");
            return;
        }
        if (convoUIDs == null) {
            player.sendMessage(MessageUtils.BAD + "There is no conversation with that category.");
            return;
            ...
            for (Integer convoUID : convoUIDs) {
                ...
                conversationText.setColor(MessageUtils.EDITING_OPTION);
                ...
                immediateConvo.setColor(MessageUtils.EDITING_OPTION);
            ...
            separator.setText("   ");
            player.sendMessage(MessageUtils.EDITING + String.format("The conversation '%s:%s:%s' doesn't exist. Would you like to create it?", global, localName, convo));
